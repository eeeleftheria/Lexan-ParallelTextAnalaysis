...
void listInsert(List list, ListNode node, Pointer value); //προσθηκη κομβου σε μια λιστα
void listDelete(List list, ListNode node); //αφαιρεση κομβου απο μια λιστα 
